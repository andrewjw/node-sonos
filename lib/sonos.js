...
var Search = function Search() {
  ...
  debug('eth0: ', eth0)
  var subnet = ip.subnet(eth0.address, eth0.netmask or '255.255.255.0')
  debug('subnet: ', subnet)

  var PLAYER_SEARCH = new Buffer(['M-SEARCH * HTTP/1.1',
  'HOST: ' + subnet.broadcastAddress + ':reservedSSDport',
  'MAN: ssdp:discover',
  'MX: 1',
  ...
  this.socket.bind(function() {
    ...
    _this.socket.send(PLAYER_SEARCH, 0, PLAYER_SEARCH.length, 1900, subnet.broadcastAddress);
  });
